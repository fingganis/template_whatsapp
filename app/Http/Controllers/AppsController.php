...
class AppsController extends Controller
{
    ...
    public function webchatApp()
    {
        ...
        return view('/content/apps/webchat/app-webchat', [
            'pageConfigs' => $pageConfigs
        ]);
    }
    ...
    {
        $pageConfigs = ['pageHeader' => false];
        return view('/content/apps/subs/page-pricing', ['pageConfigs' => $pageConfigs]);
    }
    ...
    // Email App
    public function manageinstanceApp()
    {
        $pageConfigs = [
            'pageHeader' => false,
            'contentLayout' => "content-left-sidebar",
            'pageClass' => 'manageinstanceApp-application',
        ];

        return view('/content/apps/manageinstance/app-manageinstance', ['pageConfigs' => $pageConfigs]);
    }
    // ToDo App
