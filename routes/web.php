...
use App\Http\Controllers\ManageinstanceController;
use App\Http\Controllers\PingController;
use App\Http\Controllers\ScrapController;
use App\Http\Controllers\BulkController;
// use App\Http\Controllers\ChatbotController;
// use App\Http\Controllers\PhonebookController;
// use App\Http\Controllers\SinglemessagesController;
...
/* Route subscription */
Route::get('subs', [SubsController::class, 'index'])->name('subs');
Route::get('subs/payment/{id}', [SubsController::class, 'payment'])->name('subs');
/* Route manageinstance */
Route::get('manageinstance', [ManageinstanceController::class, 'index'])->name('manageinstance');
/* Route ping */
Route::get('ping', [PingController::class, 'index'])->name('ping');
/* Route Scraping */
Route::get('scrap', [ScrapController::class, 'index'])->name('scrap');
/* Route Bulk */
...
// /* Route single messages */
// Route::get('single-messages', [SinglemessagesController::class, 'index'])->name('single-messages');
// /* Route template */
...
Route::group(['prefix' => 'app'], function () {
    Route::get('manageinstance', [AppsController::class, 'manageinstanceApp'])->name('app-manageinstance');
    Route::get('chat', [AppsController::class, 'chatApp'])->name('app-chat');
    Route::get('webchat', [AppsController::class, 'webchatApp'])->name('app-webchat');
