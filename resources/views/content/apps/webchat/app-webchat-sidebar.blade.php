...
<div class="sidebar-content">
    ...
    <div id="users-list" class="chat-user-list-wrapper list-group">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item active">
                <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab"
                    data-bs-target="#navs-top-chat" aria-controls="navs-top-chat" aria-selected="true">
                    <h5 class="mb-0">Chat</h5>
                </button>
            </li>
            <li class="nav-item">
                <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-top-grup"
                    aria-controls="navs-top-grup" aria-selected="true">
                    <h5 class="mb-0">Grup</h5>
                </button>
            </li>
        </ul>
        <div class="tab-content">
            <div class="tab-pane active" id="navs-top-chat" aria-labelledby="chat-tab" role="tabpanel">
                <ul class="chat-users-list chat-list media-list">
                    <li>
                        <span class="avatar"><img src="{{asset('images/portrait/small/avatar-s-3.jpg')}}" height="42"
                        ...
                        <div class="chat-info flex-grow-1">
                            ...
                            <p class="card-text text-truncate">
                                Cake pie jelly jelly beans. Marzipan lemon drops halvah cake. Pudding cookie lemon drops
                                icing
                            </p>
                        </div>
                    ...
                    <li>
                        <span class="avatar"><img src="{{asset('images/portrait/small/avatar-s-7.jpg')}}" height="42"
                                width="42" alt="Generic placeholder image" />
                    ...
                    <li>
                        <span class="avatar"><img src="{{asset('images/portrait/small/avatar-s-8.jpg')}}" height="42"
                                width="42" alt="Generic placeholder image" />
            ...
            <div class="tab-pane" id="navs-top-grup" aria-labelledby="grup-tab" role="tabpanel">
                <ul class="chat-users-list chat-list media-list">
                    <li>
                        <span class="avatar"><img src="{{asset('images/profile/post-media/25.jpg')}}" height="42"
                                width="42" alt="Generic placeholder image" />
                            <span class="avatar-status-online"></span>
                        </span>
                        <div class="chat-info flex-grow-1">
                            <h5 class="mb-0">Grup Kelas 1</h5>
                            <p class="card-text text-truncate">
                                Kumpul kuy
                            </p>
                        </div>
                        <div class="chat-meta text-nowrap">
                            <small class="float-end mb-25 chat-time">4:14 PM</small>
                            <span class="badge bg-danger rounded-pill float-end">15</span>
                        </div>
                    </li>
                    <li>
                        <span class="avatar"><img src="{{asset('images/profile/post-media/kopi.jpg')}}" height="42"
                                width="42" alt="Generic placeholder image" />
                            <span class="avatar-status-online"></span>
                        </span>
                        <div class="chat-info flex-grow-1">
                            <h5 class="mb-0">Grup Ngopi</h5>
                            <p class="card-text text-truncate">
                                inpo ngopi masseehhh!
                            </p>
                        </div>
                        <div class="chat-meta text-nowrap">
                            <small class="float-end mb-25 chat-time">9:09 AM</small>
        ...
        <ul class="chat-users-list contact-list media-list">
            <li>
                <span class="avatar"><img src="{{asset('images/portrait/small/avatar-s-7.jpg')}}" height="42" width="42"
                        alt="Generic placeholder image" />
                </span>
                <div class="chat-info">
                    <h5 class="mb-0">Jenny Perich</h5>
                    <p class="card-text text-truncate">
                        Tart dragée carrot cake chocolate bar. Chocolate cake jelly beans caramels tootsie roll candy
                        canes.
                    </p>
                </div>
            </li>
            <li>
                <span class="avatar"><img src="{{asset('images/portrait/small/avatar-s-5.jpg')}}" height="42" width="42"
                        alt="Generic placeholder image" />
                </span>
                <div class="chat-info">
            ...
            <li>
                <span class="avatar"><img src="{{asset('images/portrait/small/avatar-s-9.jpg')}}" height="42" width="42"
                        alt="Generic placeholder image" />
                </span>
                <div class="chat-info">
            ...
            <li>
                ...
                <div class="chat-info">
                    ...
                    <p class="card-text text-truncate">
                        Wafer toffee tart jelly cake croissant chocolate bar cupcake donut. Fruitcake gingerbread
                        tiramisu sweet
                        jelly-o.
                    </p>
                </div>
            ...
            <li>
                <span class="avatar"><img src="{{asset('images/portrait/small/avatar-s-15.jpg')}}" height="42"
                        width="42" alt="Generic placeholder image" />
                </span>
                <div class="chat-info">
                    <h5 class="mb-0">Kristopher Candy</h5>
            ...
            <li>
                <span class="avatar"><img src="{{asset('images/portrait/small/avatar-s-14.jpg')}}" height="42"
                        width="42" alt="Generic placeholder image" />
                </span>
                <div class="chat-info">
            ...
            <li>
                <span class="avatar"><img src="{{asset('images/portrait/small/avatar-s-17.jpg')}}" height="42"
                        width="42" alt="Generic placeholder image" />
                </span>
                <div class="chat-info">
            ...
            <li>
                <span class="avatar"><img src="{{asset('images/portrait/small/avatar-s-3.jpg')}}" height="42" width="42"
                        alt="Generic placeholder image" />
                </span>
                <div class="chat-info">
                    <h5 class="mb-0">Elizabeth Elliott</h5>
            ...
            <li>
                <span class="avatar"><img src="{{asset('images/portrait/small/avatar-s-13.jpg')}}" height="42"
                        width="42" alt="Generic placeholder image" />
                </span>
                <div class="chat-info">
