                            ...
                            <div class="mb-1 row">
                                <div class="col-sm-12 btn-group" role="group" aria-label="Basic example">
                                    <button type="button" id="btn1"
                                        class="btn btn-primary waves-effect waves-float waves-light">Select Template</button>
                                    <button type="button" id="btn2"
                                        class="btn btn-primary waves-effect waves-float waves-light">Select Manual</button>
                                </div>
                            </div>
                        </div>
...
<h2 class="modal-title"><b>Bulk Messages
