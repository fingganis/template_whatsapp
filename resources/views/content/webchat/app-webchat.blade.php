...
@include('content/apps/webchat/app-webchat-sidebar')
@endsection
    ...
    <div class="start-chat-area">
        ...
        <div class="d-flex align-items-center">
            <select id="UserRole" class="form-select">
                ...
                <option value="poco" class="text-capitalize">Poco M3</option>
                <option value="samsung" class="text-capitalize">Samsung J3</option>
            </select>
            <button class="btn btn-primary" 
                type="button">Syncron to whatsapp</button>
        </div>
    </div>
